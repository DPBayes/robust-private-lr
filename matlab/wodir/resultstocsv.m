...
m = nanmean(res);
s = std(res);
csvwrite('wpc-e2-plr-mean.csv',m);
csvwrite('wpc-e2-plr-std.csv',s);
...
m = nanmean(res);
s = std(res);
csvwrite('wpc-e2-oplr-mean.csv',m);
csvwrite('wpc-e2-oplr-std.csv',s);
...
m = nanmean(res);
s = std(res);
csvwrite('wpc-e2-fmlr-mean.csv',m);
csvwrite('wpc-e2-fmlr-std.csv',s);
